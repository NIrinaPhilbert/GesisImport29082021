    ...
    for index, row in dfexcel.iterrows():
        if(index >= 0):
            ...
            if check_if_row_dataframe_has_value(dfexcel, index, ListNomColonneInutile, codegesisfs, ou_uid) == True:
                print("\n\n")
                print("debut Iteration ligne Tableau 18")
                ...
                continue
            print("fin insertion tab18 ligne N°", index, "du code gesis", codegesisfs, "periode", zPeriode)
        else:
            continue
...
filedbname = 'Tab18Test.csv'
Tablename = 'tRM_CSB_GES_STO_INTRANTS'
#print(os.environ.get('w_param'))
#print("user name="+os.environ["userdhis2"])
#print("user password="+os.environ["pwddhis2"])
print("Test tab 18 insert DHIS2")
